    ...
    return (
        <div className="w-[20%] h-screen bg-gray-300 flex flex-col items-center p-5 dark:bg-gray-900 dark:text-gray-">
            ...
            <ul className="space-y-4 w-full">
                <li>
                    <button
                        ...
                        className="flex items-center w-full p-2 rounded-lg text-black dark:hover:bg-slate-500 hover:bg-orange-500 hover:text-white transition duration-300 transform hover:scale-105"
                    >
            ...
            <button
                ...
                className="flex justify-center items-center w-full p-2 mt-4 bg-red-500 text-white rounded-lg hover:bg-red-600 transition duration-300 transform hover:scale-105"
            >
